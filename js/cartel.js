const createCartel = (e, notices) => {
    ...
    incontournables.map(notice => {
        ...
        var src = `img/nobg-${window.utils.normalize_string(notice["Type d'objet"]).replace("'", "_")}.svg`
        ...
        let type_icon = document.createElement("img")
            ...
            type_icon.setAttribute("src", `img/${window.utils.normalize_string(notice["Type d'objet"]).replace("'", "_")}.svg`)
    ...
    $('.single-item').slick({
        ...
        prevArrow: '<button type="button" class="custom-prev-button widget" id="prevButton"><img src="img/chevron.svg" alt="Instrument précédente" class="chevron-left" aria-hidden="true"/><span class="sr-only">Entrée précédente</span></button>',
        nextArrow: '<button type="button" class="custom-next-button widget" id="nextButton"><img src="img/chevron.svg" alt="Instrument suivante" class="chevron-right" aria-hidden="true"/><span class="sr-only">Entrée suivante</span></button>',
